...
CREATE TABLE estabelecimentos_p0 PARTITION OF estabelecimentos FOR VALUES WITH (MODULUS 8, REMAINDER 0);
CREATE TABLE estabelecimentos_p1 PARTITION OF estabelecimentos FOR VALUES WITH (MODULUS 8, REMAINDER 1);
CREATE TABLE estabelecimentos_p2 PARTITION OF estabelecimentos FOR VALUES WITH (MODULUS 8, REMAINDER 2);
CREATE TABLE estabelecimentos_p3 PARTITION OF estabelecimentos FOR VALUES WITH (MODULUS 8, REMAINDER 3);
CREATE TABLE estabelecimentos_p4 PARTITION OF estabelecimentos FOR VALUES WITH (MODULUS 8, REMAINDER 4);
CREATE TABLE estabelecimentos_p5 PARTITION OF estabelecimentos FOR VALUES WITH (MODULUS 8, REMAINDER 5);
CREATE TABLE estabelecimentos_p6 PARTITION OF estabelecimentos FOR VALUES WITH (MODULUS 8, REMAINDER 6);
CREATE TABLE estabelecimentos_p7 PARTITION OF estabelecimentos FOR VALUES WITH (MODULUS 8, REMAINDER 7);
...
CREATE TABLE socios_p0 PARTITION OF socios FOR VALUES WITH (MODULUS 8, REMAINDER 0);
CREATE TABLE socios_p1 PARTITION OF socios FOR VALUES WITH (MODULUS 8, REMAINDER 1);
CREATE TABLE socios_p2 PARTITION OF socios FOR VALUES WITH (MODULUS 8, REMAINDER 2);
CREATE TABLE socios_p3 PARTITION OF socios FOR VALUES WITH (MODULUS 8, REMAINDER 3);
CREATE TABLE socios_p4 PARTITION OF socios FOR VALUES WITH (MODULUS 8, REMAINDER 4);
CREATE TABLE socios_p5 PARTITION OF socios FOR VALUES WITH (MODULUS 8, REMAINDER 5);
CREATE TABLE socios_p6 PARTITION OF socios FOR VALUES WITH (MODULUS 8, REMAINDER 6);
CREATE TABLE socios_p7 PARTITION OF socios FOR VALUES WITH (MODULUS 8, REMAINDER 7);

...
DROP MATERIALIZED VIEW IF EXISTS mv_lookup_municipios;
DROP MATERIALIZED VIEW IF EXISTS mv_lookup_cnaes;
...
-- Restore aggregate tables from 000009 (empty; run refresh after rollback import).
